...
// func (d DeliveryDAOSqlite) Save(delivery *domain.Delivery) error {
...
// func (d DeliveryDAOSqlite) FindById(deliveryId uint) (*domain.Delivery, error) {
...
// func (d DeliveryDAOSqlite) ListDeliveryByCompanyId(id int) ([]domain.Delivery, error) {
...
// func (d DeliveryDAOSqlite) ListDeliveryByDriverId(driverId int) ([]domain.Delivery, error) {
...
// func (d DeliveryDAOSqlite) FindLocationsByDeliveryID(deliveryID int) ([]domain.Location, error) {
